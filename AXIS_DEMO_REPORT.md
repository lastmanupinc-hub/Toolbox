...
**Key Findings**: Interactive vanilla JS component (zero dependencies) visualizing 17 programs × 80 generators. Filter by tier, click-to-expand outputs, animated pipeline flow. midnight_command theme with CSS-in-JS. Full data model and interaction spec.
...
### Program 17: Payment (PRO — NOT GENERATED)
**Generators**: 0 of 4 · **Grade**: F

Payment processing integration is the only Grade F capability (81/82 Grade A). This is an external dependency (Stripe integration) that has not been implemented. The remaining 4 generators for this program are blocked on business decision, not technical limitation.
...
| Programs with output | 16 (Payment = Grade F, no output) |
...
- 80 generators described in axis_all_tools.yaml are real and produce real artifacts
...
*Generated by AXIS Toolbox · 17 programs · 80 generators · v0.4.0*
