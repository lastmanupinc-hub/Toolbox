...
const PROGRAMS = [
  ...
  { name: "mcp",                tier: "pro",  outputs: 10, key: "mcp-config.json, mcp-registry-metadata.json, protocol-spec.md, spec.types.ts, mcp/README.md, mcp/project-setup.md, mcp/build-artifacts.md, connector-map.yaml, capability-registry.json, server-manifest.yaml" },
...
const MCP_TOOLS = [
  { tool: "analyze_repo",                  auth: true,  desc: "Analyze any public GitHub repo. Returns snapshot_id + 92 artifacts." },
  { tool: "analyze_files",                 auth: true,  desc: "Analyze inline files [{path,content}]. Returns snapshot_id + 92 artifacts." },
