...
const PROGRAM_DOCS: ProgramDoc[] = [
  ...
  },
  {
    ...
    tier: "pro", generatorCount: 7,
    endpoints: ["POST /v1/mcp/provision", "POST /v1/mcp/configure", "GET /v1/mcp/registry"],
    outputFiles: ["mcp-config.json", "mcp-registry-metadata.json", "protocol-spec.md", "spec.types.ts", "connector-map.yaml", "capability-registry.json", "server-manifest.yaml"],
