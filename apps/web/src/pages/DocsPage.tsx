...
const PROGRAM_DOCS: ProgramDoc[] = [
  ...
  },
  {
    ...
    tier: "pro", generatorCount: 12,
    endpoints: ["POST /v1/mcp/provision", "POST /v1/mcp/configure", "GET /v1/mcp/registry"],
    outputFiles: ["mcp-config.json", "mcp-registry-metadata.json", "protocol-spec.md", "spec.types.ts", "mcp/README.md", "mcp/project-setup.md", "mcp/build-artifacts.md", "mcp/package-json.root.template.json", "mcp/package-json.package.template.json", "connector-map.yaml", "capability-registry.json", "server-manifest.yaml"],
