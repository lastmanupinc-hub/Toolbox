...
> 5 real codebases analyzed by Axis' Iliad. Each example shows the **3 free-tier artifacts** (AGENTS.md, CLAUDE.md, .cursorrules) that every project receives. The full AXIS analysis generates **92 artifacts across 18 programs** — upgrade to Pro to unlock all of them.
...
> **Want the full 92 artifacts?** The Pro tier generates design tokens, brand guidelines, debug playbooks, SEO analysis, generated components, Remotion scripts, and 70+ more files. [Try it →](https://axis-iliad.jonathanarvay.com)

## Full AXIS Output (92 artifacts across 18 programs)
...
- **MCP** — mcp-config.json, mcp-registry-metadata.json, protocol-spec.md, spec.types.ts, mcp/README.md, mcp/project-setup.md, mcp/build-artifacts.md, connector-map.yaml, capability-registry.json, server-manifest.yaml
