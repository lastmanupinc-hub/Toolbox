...
One scan → 94 artifacts across 18 programs, ready in seconds:
...
| Connect AI tools (MCP) | **MCP** | `mcp-config.json`, `mcp-registry-metadata.json`, `protocol-spec.md`, `spec.types.ts`, `mcp/README.md`, `mcp/project-setup.md`, `mcp/build-artifacts.md`, `mcp/package-json.root.template.json`, `mcp/package-json.package.template.json`, `capability-registry.json`, `server-manifest.yaml` |
